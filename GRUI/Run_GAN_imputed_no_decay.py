...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='../GRUD/checkpoint_physionet_imputed_no_decay',
                        help='Directory name to save the checkpoints')
    parser.add_argument('--log-dir', type=str, default='../GRUD/logs_physionet_imputed_no_decay',
